 ...
 * 100285256
 * 
 * object to represent a King piece in the game of Chess. 
 */
...
public class King extends Piece {
	 ...
	 */
	public King(String col, int x, int y){
		colour = col;
		...
		if(col.equalsIgnoreCase("white")){
			kingImg = new MyImg(Definition.IMG_KING_WHITE, this.x, this.y);
		}else{
			kingImg = new MyImg(Definition.IMG_KING_BLACK, this.x, this.y);
		}
